...
import { LawyerTourGuide } from "@/components/malte/LawyerTourGuide";
import {
  AppHeader,
  BottomNav,
  Card,
      ...
      switch (stepId) {
        ...
        case 6:
          if (dossier) {
            ...
            toast.success("Vzorový súdny posudok (A4) so SHA-256 pečaťou vygenerovaný.");
          }
          break;
      }
    },
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="flex items-center justify-between px-1 text-[10px] uppercase font-bold text-muted-foreground tracking-wider">
                    ...
                    <span className="text-primary font-mono">3 kľúčové perspektívy</span>
                  </div>
                  <div className="grid grid-cols-3 gap-1.5">
                    ...
                    >
                      ...
                      <span className="truncate">⏱️ Časová os</span>
                    </button>
                    <button
                      type="button"
