      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('malte:theme')||'light';if(t==='system'){t='light';try{localStorage.setItem('malte:theme','light')}catch(e2){}}var d=t==='dark';if(d){document.documentElement.classList.add('dark');document.documentElement.style.colorScheme='dark';}else{document.documentElement.classList.remove('dark');document.documentElement.style.colorScheme='light';}}catch(e){}})();`,
          }}
        />
        <HeadContent />
      </head>
